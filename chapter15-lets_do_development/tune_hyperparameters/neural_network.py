...
# Calculating gradients over logistic regression
...
# Initializing random weights for all nodes of neural network
...
# Preparing batches according to set parameters
...
# Print function for printing each iteration log
