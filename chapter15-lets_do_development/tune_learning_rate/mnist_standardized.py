...
X_train_raw = load_images("/programming-machine-learning/data/mnist/train-images-idx3-ubyte.gz")
X_test_raw = load_images("/programming-machine-learning/data/mnist/t10k-images-idx3-ubyte.gz")
...
Y_test_all = load_labels("/programming-machine-learning/data/mnist/t10k-labels-idx1-ubyte.gz")
